      ...
      <tbody>
        ...
        <tr>
          <td colspan="2" style="padding:30px 0;">
            ...
            <p style="margin:0 10px 10px 10px;padding:0;">This message is to confirm that the LuvPay account with the username <b>${user.username}</b> belongs to you. Verifying your email address helps you secure your account.  If you forget your password, you will now be able to reset it by email.</p>
            <p style="margin:0 10px 10px 10px;padding:0;">To confirm that this is your luvpay account, click here:</p>
            <p>
        ...
        <tr>
          <td colspan="2" style="padding:30px 0 0 0;border-top:1px solid #e9edee;color:#9b9fa5">
            If this is not your LuvPay account, don't worry, someone probably just typed the wrong email address.
          </td>
        </tr>
      </tbody>
    </table>
